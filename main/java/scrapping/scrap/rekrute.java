                ...
                try {
                    ...
                    for (Element element : elements) {
                        ...
                        try {
                            ...
                            String titre = element.select("#fortopscroll > div.container.anno > div:nth-child(2) > div > div.col-md-12.info.blc.noback > div > div > div.col-md-10.col-sm-12.col-xs-12 > h1").text();
                            ...
                            String siteEntreprise =detailDoc.select("#fortopscroll > div.container.anno > div:nth-child(2) > div > div.col-md-12.info.blc.noback > div > div > div.col-md-2.col-sm-12.col-xs-12 > div > a").text();
